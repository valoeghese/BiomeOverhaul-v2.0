...
/**
 * The base interface for all decorators. It is recommended that you use {@link GenDecorator} for creating your own types.
 * 
 * @see GenDecorator
...
public interface DecoratorBase {
	 ...
	 * 
	 * @param world the chunk region "world" to decorate.
